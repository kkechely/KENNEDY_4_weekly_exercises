...
```
  ...
  This map shows the household income in each neighborhood. The wealthier neighborhoods are in the southwest of Minneapolis and the poorer neighboorhoods are in the center of the city.
